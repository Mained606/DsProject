...
namespace JWS
{
    public class QuestManager : BaseManager<QuestManager>
    {
        ...
        {
            base.Start();
            baseDatabase = GenerateMainQuestLists();
            baseDatabase.AddRange(GenerateQuestLists());
            npcDatabase = GenerateRandomNPCs(100, baseDatabase, ItemManager.ItemDatabase);
        ...
        public List<Quest> GenerateMainQuestLists()
        {
            List<Quest> questList = new List<Quest>
            {
                ...
                new Quest("메인퀘스트", "quest103", "알의 신비",
                    ...
                    new List<Reward> { new Reward("item001", 1, 90, 90) }),
                ...
                new Quest("메인퀘스트", "quest106", "새로운 힘",
                    ...
                    new Dictionary<string, QuestCondition>
                    {
                        { "item_rock", new QuestCondition(QuestConditionType.Collect, 5) },
                        { "item_tree", new QuestCondition(QuestConditionType.Collect, 5) }
                    },
                    new List<Reward> { new Reward("", 0, 90, 20) }), // 체력 증가
                ...
                new Quest("메인퀘스트", "quest108", "강해지기 위한 연습",
                    ...
                    new Dictionary<string, QuestCondition> { { "location_005", new QuestCondition(QuestConditionType.Explore, 1) } },
                    new List<Reward> { new Reward("", 0, 90, 90) }), // 스탯 증가 보상 포함
        ...
        public List<Quest> GenerateQuestLists()
        {
            List<Quest> questList = new List<Quest>
            {
                new Quest("서브퀘스트", "quest001", "회복 포션 수집", "회복 포션 10개를 수집하세요.",
                ...
                new Quest("서브퀘스트", "quest003", "가죽 갑옷 제작", "가죽 갑옷 제작을 위한 재료를 모으세요.",
                ...
                new Quest("서브퀘스트", "quest005", "유령의 눈 회수", "유령의 눈 2개를 회수하세요.",
                ...
                new Quest("서브퀘스트", "quest007", "마나 포션 전달", "상인에게 마나 포션 5개를 전달하세요.",
                ...
                new Quest("서브퀘스트", "quest009", "불꽃의 결정 탐사", "불꽃의 결정을 수집하세요.",
                ...
                new Quest("서브퀘스트", "quest011", "마법 검 제작", "마법 검 제작 재료를 모으세요.",
                new Dictionary<string, QuestCondition> { { "item022", new QuestCondition(QuestConditionType.Collect, 2) } },
                ...
                new Quest("서브퀘스트", "quest013", "룬검 강화", "룬검을 강화하기 위한 재료를 모으세요.",
                ...
                new Quest("서브퀘스트", "quest015", "전설의 검 탐사", "전설의 검을 회수하세요.",
                new Dictionary<string, QuestCondition> { { "location_003", new QuestCondition(QuestConditionType.Explore, 1) } },
                ...
                new Quest("서브퀘스트", "quest017", "전설의 증표 회수", "전설의 증표를 회수하세요.",
                ...
                new Quest("서브퀘스트", "quest019", "마을 방어", "몬스터의 공격으로부터 마을을 방어하세요.",
